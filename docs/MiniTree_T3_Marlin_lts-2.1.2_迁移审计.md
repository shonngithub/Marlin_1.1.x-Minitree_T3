...
RAM:   66.4% (5439 / 8192 bytes)
Flash: 67.9% (172336 / 253952 bytes)
```
...
| M109/M190 显示当前 SD 文件名 | 是 | 使用新版状态栏 API 显示当前长文件名，并启用 UTF-8 状态消息滚动 |
...
- 从 SD 打印含 `M109`、`M190` 的文件，确认等待加热时状态栏显示并滚动当前
  文件名；温度数值应继续由状态页正常显示。
