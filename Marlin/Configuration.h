...
#define CUSTOM_MACHINE_NAME "MiniTree T3"
...
#define PID_MAX  200      // MiniTree T3 hotend power limit
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 380.34
  #define DEFAULT_BED_KI  66.65
  #define DEFAULT_BED_KD 429.85
...
#define X_MIN_ENDSTOP_INVERTING true  // Verify with M119 before homing.
#define Y_MIN_ENDSTOP_INVERTING true  // Verify with M119 before homing.
#define Z_MIN_ENDSTOP_INVERTING true  // Verify with M119 before homing.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Verify with M119 before probing.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 20, 0 } // Recalibrate Z with M851.
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Sensor is fitted in normal use. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_PIN       19         // MiniTree T3 uses the RAMPS Z-MAX connector.

  #define FIL_RUNOUT_STATE     LOW        // LOW means runout; an open connector is held HIGH.
  #define FIL_RUNOUT_PULLUP               // Keeps an unconnected sensor input inactive.
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT   // The legacy M01 EEPROM layout is not compatible.
