 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        // Seconds 考察掉温
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 20                // Seconds  考察升温
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 90    // Seconds 考察掉温
  #define THERMAL_PROTECTION_BED_HYSTERESIS 5 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 60                // Seconds 考察升温
...
#define ADVANCED_PAUSE_FEATURE
 ...
 //#define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.  // 关掉后, 暂停不抬起, 但是断料依然会抬起
